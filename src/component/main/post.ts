			...
			<div class="container" style="width:768px">
				<header>
					...
					<p>
						...
						· 작성일 : ${post.createdDate.substring(0, 10)} · 수정일 : ${post.modifiedDate.substring(0, 10)}
					</p>
					<div id="taglist"></div>
				</header>
				<article id="post">${unsafeHTML(marked.parse(post.content))}</article>
				<div class="d-flex justify-content-center">
					<button id="likeBtn" class="btn btn-outline-danger rounded-sm rounded-circle" style="width:55px;height:55px;">
						<svg
				...
				<div class="input-group py-1">
					...
					<button id="writeComment" class="btn btn-primary col-1">댓글 작성</button>
				</div>
