          ...
          <li class="nav-item mx-1">
            <div class="dropdown">
              <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu" id="notice">
                </ul>
              </div>
          </li>
          <li class="nav-item">
...
export function setNotice(notices:Array<object>){
    let noticeElement:HTMLElement = document.getElementById("notice")!;
